...
def math_model(m_nr=10, t_nr=10, p=1, q=1, TagEveryMessage=True, AtLeastOnce=False, EquivalentA=False, **kwargs):
    ...
    try:
        ...
        m.setParam(GRB.Param.TimeLimit, 100720)
        # m.setParam(GRB.Param.MIPGap, 0.02)
